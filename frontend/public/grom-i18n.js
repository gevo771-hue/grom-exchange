...
(function () {
  ...
  var STR = {
    ru: {
      ...
      wc_toast_confirm_wallet: 'Подтверди в {wallet}, затем вернись в браузер',
      wc_toast_sign_siwe: 'Вернись в браузер и подпиши сообщение в кошельке для входа',
      wc_toast_siwe_rejected_mobile: 'Подпиши сообщение в кошельке (открой Trust) — без подписи вход не завершится.',
      wc_toast_siwe_rejected_desktop: 'Подпиши сообщение в кошельке, чтобы завершить вход.',
      tk_title_from: 'Мой кошелёк',
      tk_title_to: 'Получаешь',
      tk_search_wallet: 'Поиск по монетам в кошельке…',
      tk_search_targets: 'Поиск монет для обмена…',
      tk_empty_wallet: 'В кошельке пока нет монет — пополни баланс, затем выбери что отдать.',
      tk_need_connect: 'Подключи кошелёк, чтобы видеть свои монеты.',
      tk_need_from: 'Сначала выбери монету в «Отдаёшь».',
      tk_group_same: 'Та же сеть · дёшево · быстро',
      tk_group_cross: 'Кросс-чейн (мост · 1–5 мин)',
      tk_loading: 'Загрузка баланса…',
      tk_tron_open_trust: 'Открой GROM в Trust Wallet (сеть Tron), чтобы свопать TRX…',
      tk_tron_need_wallet: 'Для свопа TRX нужен Trust (DApp) или TronLink',
      ...
      pg_spot_sub: 'Свап 10 000+ токенов · баланс кошелька · лучший DEX-маршрут',
      ...
      lp_prod_bo_p: 'Живые вероятности по крипте, политике и спорту. Вход через кошелёк — без депозита.',
    ...
    en: {
      ...
      wc_toast_confirm_wallet: 'Confirm in {wallet}, then return to the browser',
      wc_toast_sign_siwe: 'Return to the browser and sign the message in your wallet to log in',
      wc_toast_siwe_rejected_mobile: 'Sign the message in your wallet (open Trust) — sign-in cannot finish without it.',
      wc_toast_siwe_rejected_desktop: 'Sign the message in your wallet to finish signing in.',
      tk_title_from: 'My wallet',
      tk_title_to: 'You receive',
      tk_search_wallet: 'Search tokens in your wallet…',
      tk_search_targets: 'Search tokens you can swap to…',
      tk_empty_wallet: 'No tokens in your wallet yet — deposit first, then choose what to pay with.',
      tk_need_connect: 'Connect a wallet to see your tokens.',
      tk_need_from: 'Pick a token in “You pay” first.',
      tk_group_same: 'Same chain · cheap · fast',
      tk_group_cross: 'Cross-chain (bridge · 1–5 min)',
      tk_loading: 'Loading balances…',
      tk_tron_open_trust: 'Open GROM inside Trust Wallet (Tron) to swap TRX — redirecting…',
      tk_tron_need_wallet: 'Install TronLink or open this site in Trust Wallet to swap TRX',
      ...
      pg_spot_title: 'Swap',
      pg_spot_sub: 'Swap 10 000+ tokens · wallet balances · best DEX route',
      ...
      lp_prod_bo_h: 'Prediction Markets',
      lp_prod_bo_p: 'Live probabilities on crypto, politics & sports. Non-custodial wallet sign-in — explore without a deposit.',
    ...
    es: {
      wc_toast_confirm_wallet: 'Confirma en {wallet} y vuelve al navegador',
      wc_toast_sign_siwe: 'Vuelve al navegador y firma el mensaje en tu billetera para iniciar sesión',
      wc_toast_siwe_rejected_mobile: 'Firma el mensaje en tu billetera (abre Trust); sin firma no se completa el acceso.',
      wc_toast_siwe_rejected_desktop: 'Firma el mensaje en tu billetera para terminar el inicio de sesión.',
      tk_title_from: 'Mi billetera',
      tk_title_to: 'Recibes',
      tk_search_wallet: 'Buscar tokens en tu billetera…',
      tk_search_targets: 'Buscar tokens a los que puedes cambiar…',
      tk_empty_wallet: 'Aún no hay tokens en tu billetera — deposita y luego elige qué pagar.',
      tk_need_connect: 'Conecta una billetera para ver tus tokens.',
      tk_need_from: 'Primero elige un token en “Pagas”.',
      tk_group_same: 'Misma red · barato · rápido',
      tk_group_cross: 'Cross-chain (puente · 1–5 min)',
      tk_loading: 'Cargando saldos…',
      tk_tron_open_trust: 'Abre GROM en Trust Wallet (Tron) para intercambiar TRX…',
      tk_tron_need_wallet: 'Instala TronLink o abre el sitio en Trust Wallet para TRX',
      nav_landing: 'Inicio', nav_home: 'Inicio', nav_dashboard: 'Panel', top_brand_sub: 'Finance Hub',
      nav_spot: 'SWAP', nav_binary: 'Binary', nav_wallet: 'Billetera', nav_markets: 'Mercados',
    ...
    ar: {
      wc_toast_confirm_wallet: 'أكد في {wallet} ثم عد إلى المتصفح',
      wc_toast_sign_siwe: 'عد إلى المتصفح ووقّع الرسالة في المحفظة لتسجيل الدخول',
      wc_toast_siwe_rejected_mobile: 'وقّع الرسالة في المحفظة (افتح Trust) — لن يكتمل الدخول بدون توقيع.',
      wc_toast_siwe_rejected_desktop: 'وقّع الرسالة في محفظتك لإنهاء تسجيل الدخول.',
      tk_title_from: 'محفظتي',
      tk_title_to: 'تستلم',
      tk_search_wallet: 'ابحث في رموز محفظتك…',
      tk_search_targets: 'ابحث عن رموز يمكن المبادلة إليها…',
      tk_empty_wallet: 'لا توجد رموز في محفظتك بعد — أودع أولاً ثم اختر ما ستدفع به.',
      tk_need_connect: 'اربط محفظة لرؤية رموزك.',
      tk_need_from: 'اختر أولاً رمزاً في «تدفع».',
      tk_group_same: 'نفس الشبكة · رخيص · سريع',
      tk_group_cross: '跨链 عبر الجسر · 1–5 دقائق',
      tk_loading: 'جاري تحميل الأرصدة…',
      tk_tron_open_trust: 'افتح GROM داخل Trust Wallet (Tron) لمبادلة TRX…',
      tk_tron_need_wallet: 'ثبّت TronLink أو افتح الموقع في Trust Wallet لمبادلة TRX',
      nav_landing: 'الرئيسية', nav_home: 'الرئيسية', nav_dashboard: 'لوحة التحكم', top_brand_sub: 'Finance Hub',
      nav_spot: 'سواب', nav_binary: 'Binary', nav_wallet: 'المحفظة', nav_markets: 'الأسواق',
    ...
    zh: {
      wc_toast_confirm_wallet: '请在 {wallet} 中确认，然后返回浏览器',
      wc_toast_sign_siwe: '请返回浏览器并在钱包中签名以登录',
      wc_toast_siwe_rejected_mobile: '请在钱包中签名（打开 Trust）——没有签名无法完成登录。',
      wc_toast_siwe_rejected_desktop: '请在钱包中签名以完成登录。',
      tk_title_from: '我的钱包',
      tk_title_to: '你将收到',
      tk_search_wallet: '搜索钱包中的代币…',
      tk_search_targets: '搜索可兑换的代币…',
      tk_empty_wallet: '钱包里还没有代币 — 请先充值，再选择支付币种。',
      tk_need_connect: '连接钱包以查看你的代币。',
      tk_need_from: '请先在“支付”中选择代币。',
      tk_group_same: '同链 · 便宜 · 快速',
      tk_group_cross: '跨链（桥 · 1–5 分钟）',
      tk_loading: '正在加载余额…',
      tk_tron_open_trust: '请在 Trust Wallet（Tron）中打开 GROM 以兑换 TRX…',
      tk_tron_need_wallet: '请安装 TronLink 或在 Trust Wallet 中打开本站以兑换 TRX',
      nav_landing: '首页', nav_home: '首页', nav_dashboard: '仪表盘', top_brand_sub: 'Finance Hub',
      nav_spot: '兑换', nav_binary: 'Binary', nav_wallet: '钱包', nav_markets: '市场',
    ...
    hi: {
      wc_toast_confirm_wallet: '{wallet} में पुष्टि करें, फिर ब्राउज़र पर वापस आएँ',
      wc_toast_sign_siwe: 'ब्राउज़र पर वापस जाएँ और लॉगिन के लिए वॉलेट में संदेश साइन करें',
      wc_toast_siwe_rejected_mobile: 'वॉलेट में संदेश साइन करें (Trust खोलें) — बिना साइन-इन पूरा नहीं होगा।',
      wc_toast_siwe_rejected_desktop: 'साइन-इन पूरा करने के लिए वॉलेट में संदेश साइन करें।',
      tk_title_from: 'मेरा वॉलेट',
      tk_title_to: 'आपको मिलेगा',
      tk_search_wallet: 'वॉलेट में टोकन खोजें…',
      tk_search_targets: 'जिन टोकन में स्वैप हो सकता है…',
      tk_empty_wallet: 'वॉलेट में अभी टोकन नहीं — पहले जमा करें, फिर चुनें।',
      tk_need_connect: 'अपने टोकन देखने के लिए वॉलेट कनेक्ट करें।',
      tk_need_from: 'पहले “You pay” में टोकन चुनें।',
      tk_group_same: 'समान चेन · सस्ता · तेज़',
      tk_group_cross: 'क्रॉस-चेन (ब्रिज · 1–5 मिनट)',
      tk_loading: 'बैलेंस लोड हो रहा है…',
      tk_tron_open_trust: 'TRX स्वैप के लिए Trust Wallet (Tron) में GROM खोलें…',
      tk_tron_need_wallet: 'TRX के लिए TronLink इंस्टॉल करें या Trust में साइट खोलें',
      nav_landing: 'होम', nav_home: 'होम', nav_dashboard: 'डैशबोर्ड', top_brand_sub: 'Finance Hub',
      nav_spot: 'स्वैप', nav_binary: 'Binary', nav_wallet: 'वॉलेट', nav_markets: 'मार्केट',
    ...
    tr: {
      wc_toast_confirm_wallet: '{wallet} içinde onayla, sonra tarayıcıya dön',
      wc_toast_sign_siwe: 'Tarayıcıya dön ve giriş için cüzdanda mesajı imzala',
      wc_toast_siwe_rejected_mobile: 'Cüzdanda mesajı imzala (Trust\'ı aç) — imza olmadan giriş tamamlanmaz.',
      wc_toast_siwe_rejected_desktop: 'Girişi tamamlamak için cüzdandaki mesajı imzala.',
      tk_title_from: 'Cüzdanım',
      tk_title_to: 'Alırsın',
      tk_search_wallet: 'Cüzdanındaki tokenleri ara…',
      tk_search_targets: 'Takas edebileceğin tokenleri ara…',
      tk_empty_wallet: 'Cüzdanında henüz token yok — önce yatır, sonra seç.',
      tk_need_connect: 'Tokenlerini görmek için cüzdan bağla.',
      tk_need_from: 'Önce “Ödeyeceğin” alanında token seç.',
      tk_group_same: 'Aynı ağ · ucuz · hızlı',
      tk_group_cross: 'Cross-chain (köprü · 1–5 dk)',
      tk_loading: 'Bakiyeler yükleniyor…',
      tk_tron_open_trust: 'TRX takası için Trust Wallet (Tron) içinde GROM’u aç…',
      tk_tron_need_wallet: 'TRX için TronLink kur veya siteyi Trust Wallet’ta aç',
      nav_landing: 'Ana sayfa', nav_home: 'Ana sayfa', nav_dashboard: 'Panel', top_brand_sub: 'Finance Hub',
      nav_spot: 'SWAP', nav_binary: 'Binary', nav_wallet: 'Cüzdan', nav_markets: 'Piyasalar',
