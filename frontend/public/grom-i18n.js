...
(function () {
  ...
  function setLang(lng) {
    ...
    if (ru) ru.classList.toggle('active', lng === 'ru');
    if (en) en.classList.toggle('active', lng === 'en');
  }
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    var ru = document.getElementById('langRu');
    var en = document.getElementById('langEn');
    if (ru) ru.addEventListener('click', function () { setLang('ru'); closeLangPopover(); });
    if (en) en.addEventListener('click', function () { setLang('en'); closeLangPopover(); });
    if (ru) ru.classList.toggle('active', getLang() === 'ru');
    if (en) en.classList.toggle('active', getLang() === 'en');
    ['langEs', 'langAr', 'langZh', 'langHi', 'langTr'].forEach(function (id) {
      var btn = document.getElementById(id);
      if (btn) btn.addEventListener('click', function () {
        closeLangPopover();
        if (typeof window.toast === 'function') window.toast('This language is coming soon — use English or Russian', 'info');
      });
    });
